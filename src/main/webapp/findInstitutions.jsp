...
<div class="institopnav">
    <h2>Search <b>Institutions</b> with it's Unique Name </h2>
    <input class="form-control" onchange="getInstitutions(this.value)" style="margin-left: 10px" type="text" placeholder="Search..">
</div>
...
<script src="static/js/findInstitutions.js"></script>
